        ...
        <form id="formUsuarios">    
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-lg-6">
                    <div class="form-group">
                    <label for="" class="col-form-label">NombreCompleto</label>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                        <label for="" class="col-form-label">Pwd</label>
                        <input type="text" class="form-control" id="Pwd">
                        </div>
                    </div>    
                    <div class="col-lg-6">    
                        <div class="form-group">
                        <label for="" class="col-form-label">TipoCuenta</label>
                        <input type="text" class="form-control" id="TipoCuenta">
                        </div>            
                    </div>    
                </div>                
            </div>
